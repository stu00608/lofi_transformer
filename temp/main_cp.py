...
def train():
    ...
    wandb.init(project="EMOPIA-Pretrain+Finetune-Experiment")
...
def generate():
    ...
    while sidx < num_songs:
        ...
        if n_token == 8:
            ...
            res, _ = net.inference_from_scratch(dictionary, emotion_tag, n_token, display=False)
        ...
        make_midi(res, path_outfile + '.mid', word2event)
    ...
    print(f'songs that too few tokens: {less_tokens_case}')
    print("================") 
